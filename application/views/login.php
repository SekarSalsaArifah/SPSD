...
<div class="login-box">
  ...
  <div class="login-logo mt-3" style="margin-bottom:">
    ...
    <h6 class="login-box-msg" style="margin-bottom:-8px;">Sistem Pendataan Server dan Domain</h6>
    <img src="<?=base_url('assets/img/logo.png')?>" alt="Logo" class="brand-image elevation-3 mr-2" style="width: 150px; height: auto;">
  </div>
