...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=base_url("dashadmin/dashboard")?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin dan Server</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=base_url('dashadmin/dashboard')?>" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <!-- <ul class="nav nav-treeview"> -->
              <li class="nav-item">
                <a href="<?=base_url('dashadmin')?>" class="nav-link">
                  <i class="nav-icon fas fa-user"></i>
                  <p>Pengajuan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url('dashadmin/add')?>" class="nav-link">
                  <i class="nav-icon fas fa-user"></i>
                  <p>Tambah</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url('dashadmin/get')?>" class="nav-link">
                  <i class="nav-icon fas fa-user"></i>
                  <p>Ubah</p>
                </a>
              </li>
          ...
          <li class="nav-header">SERVER</li>
           <li class="nav-item">
            <!-- <ul class="nav nav-treeview"> -->
              ...
              <li class="nav-item">
                <a href="<?= base_url('server/fisikserver') ?>" class="nav-link">
                  <i class="nav-icon fas fa-copy"></i>
                  <p>Server Fisik</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('server/appserver') ?>" class="nav-link">
                  <i class="nav-icon fas fa-copy"></i>
                  <p>Server App</p>
                </a>
              </li>
